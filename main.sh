...
show_menu() {
    options=("Add New Site" "Build Docker Containers" "Init databases" "Run Migrations" "Check Required Applications" "Generate .env File" "Generate docker-compose file" "Generate nginx config files" "Exit")
    while true; do
        clear
        echo -e "\n\033[1;36m================================\033[0m"
